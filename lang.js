...
window.FI = {
  ...
  "code.perch.2": "Kirjoitettu Swiftillä ja rakennettu ilman Xcodea: SwiftPM, <code>lipo</code> universaaliin binääriin, ja itsetestit jotka elävät julkaistun binäärin sisällä. Päivittää itsensä paikallaan ja hylkää jokaisen version jota ei ole allekirjoitettu samalla avaimella kuin ajossa oleva. Allekirjoitettu, avointa lähdekoodia, Homebrewissa, dokumentaatiosivuston kanssa.",
  "code.transcriber.1": "Liitä TikTok-, Reels- tai YouTube-linkki ja saat litteroinnin takaisin — koko videon tai minkä tahansa osan siitä, aikaleimoilla tai ilman. Se myös lataa median MP4-, MOV- tai MP3-muodossa aina 1080p:hen asti. Kaikki ajetaan paikallisesti: <code>yt-dlp</code> hakee äänen, Whisper litteroi sen, eikä mitään lähetetä ulkopuolelle.",
